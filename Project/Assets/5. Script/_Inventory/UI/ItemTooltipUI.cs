...
public class ItemTooltipUI : MonoBehaviour
{
    ...
    ***********************************************************************/
    ...
    [SerializeField] private Text needLevel_txt;

    [SerializeField] private Text ability_txt;

    [SerializeField] GameObject needLevel;
    ...
    public void SetItemInfo(ItemData data)
    {
        ...
        switch (data.ItemType)
        {
            case ItemType.WeaponItem:
                ...
                needLevel_txt.text = wid._EquipmentLevel.ToString();

                ability_txt.text = $"데미지 + {wid.Damage}";
                break;

            case ItemType.ArmorItem:
                ArmorItemData aid = data as ArmorItemData;
                needLevel_txt.text = aid._EquipmentLevel.ToString();

                ability_txt.text = $"방어력 + {aid.Defence}";
                break;

            case ItemType.PortionItem:
                needLevel.SetActive(false);
